...
public class LocalizationService {
    ...
    private static Map<String, String> englishTexts() {
        return Map.ofEntries(
                ...
                Map.entry("reg_miniapp_choice_text", "🏥 <b>Register your pharmacy</b>\n\nOpen the Mini App to fill the same steps (name, phone, hours, medicines, location, license).\n\nYou can still register in chat if you prefer."),
                Map.entry("reg_miniapp_open_button", "📱 Register in Mini App"),
                Map.entry("reg_in_chat_button", "💬 Register in chat"),
                Map.entry("reg_pending_view_status_button", "📱 View registration status"),
                ...
                Map.entry("ready_section_title", "📦 <b>My Reservations</b>\n\n✅ Ready for pickup"),
                ...
                Map.entry("see_more_pharmacies_btn", "See more pharmacies"),
                Map.entry("see_more_pharmacies_msg", "Showing the closest 5 pharmacies. Open the Mini App to see more."),
    ...
    private static Map<String, String> amharicTexts() {
        return Map.ofEntries(
                ...
                Map.entry("reg_miniapp_choice_text", "🏥 <b>ፋርማሲዎን ይመዝግቡ</b>\n\nበMini App ውስጥ ተመሳሳይ ደረጃዎችን ይሙሉ (ስም፣ ስልክ፣ ሰዓት፣ መድኃኒቶች፣ አካባቢ፣ ፈቃድ)።\n\nከፈለጉ በቻትም መመዝገብ ይችላሉ።"),
                Map.entry("reg_miniapp_open_button", "📱 በMini App ይመዝገቡ"),
                Map.entry("reg_in_chat_button", "💬 በቻት ይመዝገቡ"),
                Map.entry("reg_pending_view_status_button", "📱 የምዝገባ ሁኔታ ይመልከቱ"),
                ...
                Map.entry("ready_section_title", "📦 <b>የእኔ ቦታ ማስያዣዎች</b>\n\n✅ ለመውሰድ ዝግጁ"),
                ...
                Map.entry("reservation_rejected_user", "❌ ቦታ ማስያዣዎ ተቀባይነት አላገኘም።\n\n💊 መድሃኒት: %s\n🔢 ብዛት: %d\n📝 ምክንያት: %s"),
                ...
                Map.entry("see_more_pharmacies_btn", "ተጨማሪ ፋርማሲዎችን ይመልከቱ"),
                Map.entry("see_more_pharmacies_msg", "ቅርብ የሆኑት 5 ፋርማሲዎች ታይተዋል። ተጨማሪ ለማየት ሚኒ አፕ ይክፈቱ።"),
